...
void setAppInfo()
{
    ...
    qApp->setApplicationDisplayName(QObject::tr("Picture Tool"));
    qApp->setApplicationName(QObject::tr("Picture Tool"));
    qApp->setDesktopFileName(QObject::tr("Picture Tool"));
...
int main(int argc, char *argv[])
{
    ...
    //Utils::setUTF8Code();
    Utils::loadFonts();
    Utils::setQSS("picturetool_qss_files");
