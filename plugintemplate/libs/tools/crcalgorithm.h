 ...
 * @return                  -- 多项式公式
 */
TOOLS_EXPORT std::string getPolyFormula(CRCModel model);
 ...
 */
TOOLS_EXPORT uint32_t getInitValue(CRCModel model);
 ...
 */
TOOLS_EXPORT uint32_t getPoly(CRCModel model);
 ...
 * @return          -- 结果异或值
 */
TOOLS_EXPORT uint32_t getXorValue(CRCModel model);
 ...
 */
TOOLS_EXPORT uint32_t getInputReversal(CRCModel model);
 ...
 */
TOOLS_EXPORT bool getOutputReversal(CRCModel model);
 ...
 * @return              -- 位宽
 */
TOOLS_EXPORT int getBitsWidth(CRCModel model);

TOOLS_EXPORT quint32 CRC_Calculate(unsigned char *data, quint64 lenght, int model_);
